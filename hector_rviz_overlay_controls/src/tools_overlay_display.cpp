...
ToolsOverlayDisplay::ToolsOverlayDisplay() : QWidgetOverlayDisplay( false )
{
  show_names_property_ = new BoolProperty(
      "Show Names", true,
      "Determines whether or not the names of the tools are shown in the buttons.", this,
      SLOT( onShowNamesChanged() ) );
