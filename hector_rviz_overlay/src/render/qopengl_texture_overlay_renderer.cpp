...
namespace hector_rviz_overlay {
    QOpenGLTextureOverlayRenderer::QOpenGLTextureOverlayRenderer(rviz_common::DisplayContext *context) : TextureOverlayRenderer(context) {
    }
    ...
    void QOpenGLTextureOverlayRenderer::finishRender() {
        ...
        glTexImage2D( GL_TEXTURE_2D, 0, GL_RGBA8, qopengl_wrapper_->size().width(), qopengl_wrapper_->size().height(), 0, GL_RGBA, GL_UNSIGNED_BYTE, pixel_data_.data());
    ...
    QOpenGLContext * QOpenGLTextureOverlayRenderer::context() {
