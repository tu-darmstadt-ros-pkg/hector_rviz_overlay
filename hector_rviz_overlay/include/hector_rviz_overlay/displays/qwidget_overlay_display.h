...
protected:
  ...
  /*!
   * This method is called from onInitialize() once the Overlay was created and the Overlay's QWidget can be used.
   * If creating the Overlay fails, this method is never called.
