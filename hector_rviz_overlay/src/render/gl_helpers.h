  ...
  unsigned char bmpData[] = // All values are little-endian
      {
          0x42,
          0x4D, // Signature 'BM'
          static_cast<unsigned char>( size & 255u ),
          static_cast<unsigned char>( ( size >> 8u ) & 255u ),
          static_cast<unsigned char>( ( size >> 16u ) & 255u ),
          0x00, // Size: 138 bytes + image bytes
          0x00,
          0x00, // Unused
          0x00,
          0x00, // Unused
          ...
          static_cast<unsigned char>( width & 255u ),
          static_cast<unsigned char>( ( width >> 8u ) & 255u ),
          0x00,
          0x00, // Width (4px)
          static_cast<unsigned char>( height & 255u ),
          static_cast<unsigned char>( ( height >> 8u ) & 255u ),
          0x00,
          0x00, // Height (2px)
          0x01,
          0x00, // Planes (1)
